...
하지만 저희는 단순 정보 열람을 뛰어넘어, 다음과 같은 다양한 기능을 추가하였습니다.
1. 보다 더 직관적인 월/주/일 별 캘린더 UI 제공
2. 관심 카테고리 및 제외 키워드 설정을 통한 개인화
3. 시간표 등록을 통한 시간 충돌 회피
4. 북마크, 메모, 태그 기능을 통한 후기 작성
